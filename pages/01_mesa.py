...
def render_tarjetas(html_contenido: str, altura: int = 650):
    components.html(f"""
    <style>
      * {{ font-family: -apple-system, sans-serif; box-sizing: border-box; }}
      .prio-scroll {{ max-height:{altura-20}px; overflow-y:auto; padding-right:4px; }}
    ...
    <div class="prio-scroll">{html_contenido}</div>
